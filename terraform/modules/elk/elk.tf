...
module "ElasticSearch" {
  ...
  keys = var.ssh_keys
  image = var.image
  disk_size = var.elasticsearch_disk
...
module "APM" {
  ...
  name = "apm"
  size = var.apm_size
  custom_fqdn = var.apm_domain
  domain_id = var.tld
  keys = var.ssh_keys
  image = var.image
  
  salt_minion_roles = ["apm", "minion"]
  salt_master_droplet_id = var.salt_master_droplet_id
  salt_master_private_ip_address = var.salt_master_private_ip_address
  salt_master_public_ip_address = var.salt_master_public_ip_address
  autogenerated_ssh_private_key = var.autogenerated_ssh_private_key
...
resource "digitalocean_firewall" "apps_to_apm" {
  name = "HAProxy-To-APM"
  droplet_ids = module.APM.droplet_ids
